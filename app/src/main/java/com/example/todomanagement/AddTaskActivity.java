...
public class AddTaskActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editDate.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                dueDateValidator(s, start, before, count);

                if(s.toString().equals("")){
                    newTaskButton.setEnabled(false);
                    newTaskButton.setBackgroundColor(Color.GRAY);
                }else{
                    newTaskButton.setEnabled(true);
                    newTaskButton.setBackgroundColor(Color.MAGENTA);
                }
            }
    ...
    private void dueDateValidator(CharSequence s, int start, int before, int count){
        String current = "";
